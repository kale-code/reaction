 ...
 */
ReactionProduct.selectedTopVariant = () => {
 ...
 */
ReactionProduct.getProductsByTag = tag => {
  let hashtags;
  let newRelatedTags;
  let relatedTag;
  let relatedTags;
 ...
 */
ReactionProduct.publishProduct = productOrArray => {
 ...
 * @returns {undefined} - returns nothing, and alerts, happen here
 */
ReactionProduct.toggleVisibility = productOrArray => {
  const products = !_.isArray(productOrArray) ? [productOrArray] : productOrArray;
  for (const product of products) {
 ...
 * @returns {undefined} - returns nothing, and alerts, happen here
 */
ReactionProduct.cloneProduct = productOrArray => {
 ...
 * @returns {undefined} - returns nothing, and alerts, happen here
 */
ReactionProduct.archiveProduct = productOrArray => {
  const products = !Array.isArray(productOrArray) ? [productOrArray] : productOrArray;
 ...
 */
ReactionProduct.isAncestorDeleted = (product, includeSelf) => {
  const productIds = [
